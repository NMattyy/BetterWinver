...
string string_4(){
    if (Language == "0409"){
        return string("Microsoft ") + OSGet() + " " + commercialVersionGet() + "\n"
                    "NT Version " + ntGet() + " (OS build " + buildGet() + ")\n" + 
                    (char)169 + " Microsoft Corporation. All rights reserved.\n\n" + 
                    "The " + OSGet() + " operating system and its user interface are protected by trademark and other pending or existing intellectual property rights in the United States and other countries/regions";
    } else if (Language == "0410") {
        return string("Microsoft ") + OSGet() + " " + commercialVersionGet() + "\n"
                    "Versione NT " + ntGet() + " (build SO " + buildGet() + ")\n" + 
